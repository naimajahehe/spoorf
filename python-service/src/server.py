...
def get_status():
    ...
    # Ringkasan dual-stack: 'leak' = jumlah device dual-stack yang terblokir TAPI IPv6-nya
    # tak tercut (tak ada sesi NDP aktif) — angka kunci untuk mendeteksi kebocoran IPv6.
