...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-white tracking-tight flex items-center gap-2", className)}
    {...props}
  />
))
